...
public class Book extends AppCompatActivity {
    ...
    public void cal(float n, float m)
    {
        ...
        //code for the negative value
        if((c>=0&&c<=10)||(c<=0&&c>=-10))
        {
            rs=5;
        }
        else if((c>10&&c<=30)||(c<-10&&c>=-30))
        {
            rs=10;
        }
        else if((c>30&&c<=55)||(c<-30&&c>=-55))
        {
            rs=15;
        }
        else if((c>55&&c<=85)||(c<-55&&c>=-85))
        {
            rs=20;
        }
        else if((c>85&&c<=105)||(c<-85&&c>=-105))
        {
            rs=25;
        }
        else if((c>105&&c<=115)||(c<-105&&c>=-115))
        {
            rs=30;
        }
        else
